...
public class HelloWorld extends PApplet
{
	...
	// removed from size() as 3rd parameter: , P2D
	public void setup() {
		...
		// this.background(200, 200, 200);	  // Original background color.
		this.background(55, 0, 255);
		...
		map2.zoomAndPanTo(zoomLevel, new Location(39.16f, -84.9f));
